  ...
  return(
    ...
    <div className="col-span-1 bg-gray-50 p-10 ">
      ...
      <div className={`text-gray-700 ${!display && "hidden"} lg:block`}>
        ...
        <p className="mb-2">2. You'll be presented with one realistic work challenge at a time, think carefully and respond based on how you would act in a real situation.</p>
